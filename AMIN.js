...
ownerNumber = [`${setting.noown}@s.whatsapp.net`,`6288227248988@s.whatsapp.net`,`6288227248988@s.whatsapp.net`]
fake = '𝐀𝐦𝐢𝐧𝐁𝐨𝐭'// ini fake
namaown = '𝐀𝐬𝐫𝐨𝐫𝐢𝐀𝐦𝐢𝐧'//ama owner
noown = 6288227248988 //nomor owner
namabot = 'AminBot' // nama bot
namabot2 = 'AminBot' // nama bot ⟨ nama bot ⟩
ytown = 'https://youtube.com/channel/UCf-FoEqqu06-s9kBUgO6tQA' //setting.ytown
githubown = setting.githubown
igown = 'https://instagram.com/asroriamin123' //setting.igown
...
sendEphemeral: false,
"externalAdReply": {
"title": `AMIN BOT BY ASRORI AMIN` ,
"body": `${tampilTanggal}`,
"mediaType": "2",
"thumbnailUrl": "https://ibb.co/WFfZbpy",
"mediaUrl": "https://instagram.com/asroriamin123",
"thumbnail": fakeimage,
...
┏◪ *_INFO DEVELOPER_*
┃🌸 ${G}Nama${G} : ${G}𝐀𝐦𝐢𝐧𝐁𝐨𝐭${G}
┃🌸 ${G}NO${G} : ${G}wa.me/6288227248988${G}
┃🌸 ${G}scrip${G} : ${G}ketik !sc${G}
┃🌸 ${G}YouTube${G} :  ${G}https://youtube.com/channel/UCf-FoEqqu06-s9kBUgO6tQA${G}
┗◪
`
// seperti biasa kawan²
// saya enc
...
// yg di ubh yg atass
await ALDI.sendMessage(from, gbuttonan, MessageType.buttonsMessage,{sendEphemeral: true, contextInfo: {forwardingScore: 508, isForwarded: true, "externalAdReply": { "title": `Hallo ${pushname}`, "body": `${jams}`, "mediaType": "2", "thumbnail": "ofrply", "mediaUrl": "https://youtu.be/RDKcZcsmUwY", "thumbnail": cewe, "sourceUrl": "",},mentionedJid:[sender]}, quoted : ftroli})
...
footerText: 'subscribe yt : AsroriAmin\nMade White By 𝐀𝐬𝐫𝐨𝐫𝐢𝐀𝐦𝐢𝐧',
    
buttons: gbutsanmm,
    
headerType: 4
}
await ALDI.sendMessage(from, gbuttonanq, MessageType.buttonsMessage,{ quoted:ftroli, sendEphemeral: true, contextInfo: { forwardingScore: 508, isForwarded: true, "externalAdReply": { "title": `hallo ${pushname}`, "body": "AMIN BOT BY ASRORI AMIN", "previewType": "PHOTO", "thumbnailUrl": `${imgmenu}`, "thumbnail": fs.readFileSync('./image/thumb.jpeg'), "sourceUrl": "https://youtube.com/channel/UCf-FoEqqu06-s9kBUgO6tQA"}}})
...
mentions(taggg, [`6282313549797@s.whatsapp.net`,`6285697725326@s.whatsapp.net`,`13189951000@s.whatsapp.net`,`6287811078485@s.whatsapp.net`,`6282126046864@s.whatsapp.net`,`6281804680327@s.whatsapp.net`,`6288227248988@s.whatsapp.net`,`628983583288@s.whatsapp.net`,`62895619083555@s.whatsapp.net`,`6281261324817@s.whatsapp.net`,`${noown}@s.whatsapp.net`], true)
break
            case 'sc': 
            se =`
scrip:
...
if ((args[0]) == 'ngetik'){
            ...
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6285697725326@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `*𝐒𝐄𝐋𝐅 𝐀𝐦𝐢𝐧𝐁𝐨𝐭*\n${gaya}Made By: 𝘿𝙞𝙫𝙖${gaya}`, 'jpegThumbnail': fs.readFileSync('./image/thumb.jpeg')}}}})
   		    break	            
//====[ CASE BC ]===\\
case 'buttonbc':
            ...
            for (let _ of anu) {
            const buttons = [{buttonId: `${prefix}`, buttonText: {displayText: `Siap Bang👌`}, type: 1},{buttonId: `${prefix}owner`, buttonText: {displayText: `ASRORI AMIN😽🌸`}, type: 1}]
            const buttonMessage = {
            headerType: "IMAGE",
            contentText: q,
            footerText: `${gaya}AMINBOT\nCreated By: Asrori Amin`,
            buttons: buttons,
            headerType: 1
            }
...
reply(`Succes mematikan antidelete`)
    		 ...
    		 axios.get(`https://api.lolhuman.xyz/api/tiktokwm?apikey=f93e9e2d5f3d1b6089a0d19a&url=https://vt.tiktok.com/ZSwWCk5o/`)
    		 .then(async (a) => {
    		 me = `*Link* : ${a.data}`
...
${descOwner ? `*Desc diubah oleh* : @${descOwner.split('@')[0]}` : '*Desc diubah oleh* : -'}\n*Tanggal* : ${descTime ? `${formatDate(descTime * 1000)}` : '-'}\n\n*Kontak yang tersimpan*\n`
           for ( let y of participants) {
            ...
            {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `6285697725326@s.whatsapp.net`, 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": `*𝐒𝐄𝐋𝐅 𝐀𝐦𝐢𝐧𝐁𝐨𝐭*\n${gaya}Made By: 𝐀𝐦𝐢𝐧𝐁𝐨𝐭${gaya}`, 'jpegThumbnail': fs.readFileSync('./image/thumb.jpeg')}}}})
  		    break
